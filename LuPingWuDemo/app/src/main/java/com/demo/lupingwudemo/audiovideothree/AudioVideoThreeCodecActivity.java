 ...
 * annotation:
 */
public class AudioVideoThreeCodecActivity extends AppCompatActivity {
...
//    private EncoderThread mEncoderThread;  //编码线程
    ...
    public void checkPermission() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(AudioVideoThreeCodecActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(AudioVideoThreeCodecActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 11);
            }

            if (ContextCompat.checkSelfPermission(AudioVideoThreeCodecActivity.this, Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(AudioVideoThreeCodecActivity.this, new String[]{Manifest.permission.RECORD_AUDIO}, 12);
            }
        }
    }

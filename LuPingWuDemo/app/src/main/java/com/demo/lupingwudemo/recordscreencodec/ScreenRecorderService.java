...
public class ScreenRecorderService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            final int dpi = 1;
            mediaProjection = sMediaProjectionManager.getMediaProjection(Activity.RESULT_OK, sData);
//        mAliRtcEngine.setLocalViewConfig(mLocalAliVideoCanvas, AliRtcVideoTrackBoth);
